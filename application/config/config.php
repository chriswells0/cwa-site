...
define('CONTACT_EMAIL', 'webmaster@' . SITE_DOMAIN); // "To" and "From" address for the contact form.
define('CONTACT_NAME', SITE_AUTHOR); // Used with CONTACT_EMAIL in the contact form.
