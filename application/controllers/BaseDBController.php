...
use \CWA\MVC\Controllers\DatabaseRecordController;

require_once \CWA\LIB_PATH . 'cwa/mvc/controllers/DatabaseRecordController.php';

abstract class BaseDBController extends DatabaseRecordController
{
}
